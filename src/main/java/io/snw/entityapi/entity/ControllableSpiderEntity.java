...
public class ControllableSpiderEntity extends EntitySpider implements ControllableEntityHandle {

    private final ControllableEntity controllableEntity;

    public ControllableSpiderEntity(World world, ControllableEntity controllableEntity) {
        super(world);
