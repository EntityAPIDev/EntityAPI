...
public class BehaviourGoalHurtByTarget extends BehaviourGoalTarget {

    private boolean attackNearest;
    private int lastAttackTick;

    public BehaviourGoalHurtByTarget(ControllableEntity controllableEntity, boolean checkSenses, boolean useMelee, boolean attackNearest) {
