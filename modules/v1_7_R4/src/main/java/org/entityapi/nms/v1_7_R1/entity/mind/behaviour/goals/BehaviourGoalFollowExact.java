...
public class BehaviourGoalFollowExact extends BehaviourGoalBase {
    ...
    public BehaviourGoalFollowExact(ControllableEntity controllableEntity, org.bukkit.entity.Entity toFollow, float minDistance, float maxDistance, double navigationSpeed) {
