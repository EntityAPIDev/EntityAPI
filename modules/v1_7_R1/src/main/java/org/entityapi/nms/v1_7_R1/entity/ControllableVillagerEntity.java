...
import org.entityapi.api.entity.type.nms.ControllableVillagerHandle;
import org.entityapi.api.events.Action;
import org.entityapi.api.utils.EntityUtil;

public class ControllableVillagerEntity extends EntityVillager implements ControllableVillagerHandle {

    private final ControllableVillager controllableEntity;

    public ControllableVillagerEntity(World world, ControllableVillager controllableEntity) {
        super(world);
    ...
    @Override
    public ControllableVillager getControllableEntity() {
