...
public class BehaviourGoalDoorInteract extends BehaviourGoalBase {
    ...
    public BehaviourGoalDoorInteract(ControllableEntity controllableEntity, boolean searchForIronDoor) {
