...
public class BehaviourGoalLeapAtTarget extends BehaviourGoalBase {

    private EntityLiving target;
    private float jumpHeight;

    public BehaviourGoalLeapAtTarget(ControllableEntity controllableEntity, float jumpHeight) {
