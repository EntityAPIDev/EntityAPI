...
public class ControllableSilverfishEntity extends EntitySilverfish implements ControllableEntityHandle {

    private final ControllableEntity controllableEntity;

    public ControllableSilverfishEntity(World world, ControllableEntity controllableEntity) {
        super(world);
    ...
    @Override
    protected String t() {
        return this.controllableEntity == null ? "mob.silverfish.say" : this.controllableEntity.getSound(EntitySound.IDLE);
    }

    @Override
    protected String aT() {
        return this.controllableEntity == null ? "mob.silverfish.say" : this.controllableEntity.getSound(EntitySound.HURT);
    }

    @Override
    protected String aU() {
        return this.controllableEntity == null ? "mob.silverfish.kill" : this.controllableEntity.getSound(EntitySound.DEATH);
    }

    @Override
    protected void a(int i, int j, int k, Block block) {
        this.makeSound(this.controllableEntity == null ? "mob.silverfish.step" : this.controllableEntity.getSound(EntitySound.STEP), 0.15F, 1.0F);
    }
}