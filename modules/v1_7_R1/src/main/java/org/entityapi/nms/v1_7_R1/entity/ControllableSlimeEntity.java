...
public class ControllableSlimeEntity extends EntitySlime implements ControllableSlimeHandle {

    private final ControllableSlime controllableEntity;

    public ControllableSlimeEntity(World world, ControllableSlime controllableEntity) {
        super(world);
    ...
    @Override
    public ControllableSlime getControllableEntity() {
