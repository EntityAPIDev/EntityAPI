...
public class ControllableSheepEntity extends EntitySheep implements ControllableEntityHandle {

    private final ControllableEntity controllableEntity;

    public ControllableSheepEntity(World world, ControllableEntity controllableEntity) {
        super(world);
