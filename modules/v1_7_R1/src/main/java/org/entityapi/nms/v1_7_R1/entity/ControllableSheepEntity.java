...
public class ControllableSheepEntity extends EntitySheep implements ControllableSheepHandle {

    private final ControllableSheep controllableEntity;

    public ControllableSheepEntity(World world, ControllableSheep controllableEntity) {
        super(world);
    ...
    @Override
    public ControllableSheep getControllableEntity() {
    ...
    @Override
    protected String t() {
        return this.controllableEntity == null ? "mob.sheep.say" : this.controllableEntity.getSound(EntitySound.IDLE);
    }

    @Override
    protected String aT() {
        return this.controllableEntity == null ? "mob.sheep.say" : this.controllableEntity.getSound(EntitySound.HURT);
    }

    @Override
    protected String aU() {
        return this.controllableEntity == null ? "mob.sheep.say" : this.controllableEntity.getSound(EntitySound.DEATH);
    }

    @Override
    protected void a(int i, int j, int k, Block block) {
        this.makeSound(this.controllableEntity == null ? "mob.sheep.step" : this.controllableEntity.getSound(EntitySound.STEP), 0.15F, 1.0F);
    }
    ...
    public void makeSound(String s, float f, float f1) {
        if (s.equals("mob.sheep.shear")) {
            s = this.getSoundFor(EntitySound.SHEAR, "mob.sheep.shear");
        }
