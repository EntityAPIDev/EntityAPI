...
import org.entityapi.nms.v1_7_R1.entity.mind.behaviour.OneTimeBehaviourGoalBase;

public class BehaviourGoalMoveTowardsLocation extends OneTimeBehaviourGoalBase {

    private Location targetLocation;
    private double stopDistance;
    private double navigationSpeed;

    public BehaviourGoalMoveTowardsLocation(ControllableEntity controllableEntity, Location targetLocation, double stopDistance, double navigationSpeed) {
