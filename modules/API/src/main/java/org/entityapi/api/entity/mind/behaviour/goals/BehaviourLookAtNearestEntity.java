...
public class BehaviourLookAtNearestEntity extends Behaviour {
    ...
    public BehaviourLookAtNearestEntity(ControllableEntity controllableEntity, Class<? extends Entity> classType, float minDistance) {
        this(controllableEntity, classType, minDistance, 0.02F);
    }

    public BehaviourLookAtNearestEntity(ControllableEntity controllableEntity, Class<? extends Entity> classType, float minDistance, float chance) {
