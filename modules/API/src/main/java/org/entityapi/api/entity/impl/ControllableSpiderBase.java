...
public class ControllableSpiderBase extends ControllableBaseEntity<Spider, ControllableSpiderHandle> implements ControllableSpider {

    public ControllableSpiderBase(int id, EntityManager manager) {
        super(id, ControllableEntityType.SPIDER, manager);
    }

    public ControllableSpiderBase(int id, ControllableSpiderHandle entityHandle, EntityManager manager) {
        this(id, manager);
