...
public class ControllableIronGolemBase extends ControllableBaseEntity<IronGolem, ControllableIronGolemHandle> implements ControllableIronGolem {
    ...
    public BehaviourItem[] getDefaultTargetingBehaviours() {
        return new BehaviourItem[]{
                ...
                new BehaviourItem(3, new BehaviourMoveTowardsNearestAttackableTarget(this, InsentientEntity.class, 0, false, true, getNMSAccessor().getMonsterSelector()))
        };
    }
}