...
import org.entityapi.nms.v1_8_R1.entity.selector.EntitySelectorViewable;
...
public class BehaviourGoalAvoidEntity extends BehaviourGoalBase {
    ...
    public boolean shouldStart() {
        ...
        Vec3D vec3d = org.entityapi.nms.v1_8_R1.RandomPositionGenerator.b(this.getHandle(), 16, 7, this.getHandle().world.getVec3DPool().create(this.entityToAvoid.locX, this.entityToAvoid.locY, this.entityToAvoid.locZ));
