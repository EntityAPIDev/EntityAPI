        ...
        if (this.getHandle().aI().nextInt(50) == 0) {
            if (this.getHandle().passenger instanceof EntityHuman) {
                ...
                if (this.getHandle() instanceof EntityInsentient) {
                    eventCancelled = org.bukkit.craftbukkit.v1_8_R1.event.CraftEventFactory.callEntityTameEvent((EntityInsentient) this.getHandle(), (EntityHuman) this.getHandle().passenger).isCancelled();
                }
