...
public class BehaviourGoalTempt extends BehaviourGoalBase {
    ...
    public BehaviourGoalTempt(ControllableEntity controllableEntity, org.bukkit.Material temptItemId, boolean isScaredByMovement, double navigationSpeed) {
    ...
    @Deprecated
    public BehaviourGoalTempt(ControllableEntity controllableEntity, int temptItemId, boolean isScaredByMovement, double navigationSpeed) {
        super(controllableEntity);
        this.navigationSpeed = navigationSpeed;
        this.isScaredByMovement = isScaredByMovement;
