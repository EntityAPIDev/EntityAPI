...
public class BehaviourGoalMoveThroughVillage extends BehaviourGoalBase {
    ...
    public BehaviourGoalMoveThroughVillage(ControllableEntity controllableEntity, boolean onlyMoveAtNight, double navigationSpeed) {
            ...
            if (village == null) {
                ...
                if (this.villageDoor == null) {
                    ...
                    if (this.path != null) {
                        ...
                        Vec3D vec3d = org.entityapi.nms.v1_8_R1.RandomPositionGenerator.a(this.getHandle(), 10, 7, this.getHandle().world.getVec3DPool().create((double) this.villageDoor.locX, (double) this.villageDoor.locY, (double) this.villageDoor.locZ));
